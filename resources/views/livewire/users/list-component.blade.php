    ...
    <div class="flex flex-col">
        <div class="recent-activity">
            <div class="w-full py-2">
                <x-slot name="header">
                    <!-- Section Hero -->
                    @include('tall-acl::header', ['label' => 'Users', 'url'=>route(config('acl.routes.users.list'))])
                </x-slot>
            </div>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" scope="col"
                                        ...
                                        <x-button icon="plus" positive squared
                                            href="{{ route(config('acl.routes.users.create')) }}"
                                        ...
                                        <td>
                                            <div class="flex px-2 space-x-2 align-middle">
                                                <x-button icon="pencil" sm primary squared
                                                    href="{{ route(config('acl.routes.users.edit'), $model) }}"
